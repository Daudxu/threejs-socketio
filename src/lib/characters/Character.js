...
export class Character extends THREE.Object3D {
    ...
    update(timeStep) {
        var _a, _b, _c;
        // console.log('Character.update',timeStep);
        // 行为更新
        (_a = this.behaviour) === null || _a === void 0 ? void 0 : _a.update(timeStep);
        // 是否从地面进入车辆
        (_b = this.vehicleEntryInstance) === null || _b === void 0 ? void 0 : _b.update(timeStep);
        // console.log(this.occupyingSeat);
        // 角色状态更新
        (_c = this.charState) === null || _c === void 0 ? void 0 : _c.update(timeStep);
    ...
    springRotation(timeStep) {
        ...
        // console.log(this.orientationTarget,this.orientation,timeStep,angle);
    ...
    enterVehicle(seat, entryPoint) {
        ...
        this.resetControls();
        // 当门还没打开的时候
        if (((_a = seat.door) === null || _a === void 0 ? void 0 : _a.rotation) < 0.5) {
            // 打开门
    ...
    inputReceiverMove(event, vector) {
        ...
        // 设置往前
        this.triggerAction('up', true);
        // console.log('inputReceiverMove',this.targetDirection);
    ...
    stopControllingVehicle() {
        var _a;
        if (((_a = this.controlledObject) === null || _a === void 0 ? void 0 : _a.controllingCharacter) === this) {
